 ...
 * @LastEditTime: 2020-05-18 16:49:05
...
//   .map((element, index) => {
//     return {
//       name: font[index].querySelector('.code-name').innerText.split('#')[1],
...
class IconFont {
  ...
  //排行榜
  static const IconData ranking = IconData(0xe7bd, fontFamily: 'myIcon');
  //直播
  ...
  //排行榜
  static const IconData ranking1 = IconData(0xe609, fontFamily: 'myIcon');
  //电台
  static const IconData radioStation1 = IconData(0xe602, fontFamily: 'myIcon');
  //电台
  static const IconData radioStation12 = IconData(0xe603, fontFamily: 'myIcon');

  static const IconData ranking2 = IconData(0xe7e5, fontFamily: 'myIcon');

  static const IconData ranking3 = IconData(0xe605, fontFamily: 'myIcon');
  //日历
